...
import { luckyDrawWinners, members } from '../data/data'
import { SectionTitle } from './shared/SectionTitle';

export const TopMemberLuckyDraw = () => {
  return (
    <section className="container mx-auto px-12 my-32 py-16  bg-green-800 text-white" >
      {/* Top Members */}
      ...
      <SectionTitle title='Top Lucky Draw Winners' />
      <Swiper
        spaceBetween={20}
        slidesPerView={2}
        freeMode={true}
