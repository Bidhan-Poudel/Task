...
import { topOffers } from '../data/data';
        ...
        {topOffers.map((offer) => (
          <SwiperSlide key={offer.id}>
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm ">
              <a href="#">
                <img className="rounded-t-lg w-full h-40" src={offer.image} width={"100%"} alt="product image" />
              </a>
              <div class="px-5 py-5">
                <a href="#">
                  <h5 class="text-md font-semibold tracking-tight text-gray-900 pb-4 border-b-2 border-gray-200">{offer.name}</h5>
                </a>
